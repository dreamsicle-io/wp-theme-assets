...
class WP_Theme_Backstage {
	...
	public function init_options() {
		WP_Backstage_Options::add( 'wp_theme_options', array( 
			'title'             => __( 'WP Theme Options', 'wp-theme' ), 
			'menu_title'        => __( 'WP Theme', 'wp-theme' ), 
			'description'       => __( 'All custom Global Inclusive Growth Summit WordPress options.', 'wp-theme' ), 
			'show_in_rest'      => true, 
			'sections'          => array(
				array(
					'id'          => 'wp_theme_social', 
					...
					'fields'      => array(
						...
						array( 
							...
							'label'       => __( 'Twitter Handle', 'wp-theme' ), 
							'description' => __( 'Enter a valid twitter handle (No @). Required for enriched Twitter cards.', 'wp-theme' ), 
						),
					), 
				),
				array(
